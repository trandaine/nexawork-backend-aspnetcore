...
public static class ConnectionStringConstants
{
    ...
    public const string MessageConnectionString = "Server= localhost, 1433; Database=NexaMessageDB; User Id=sa; password=Dai@2018; TrustServerCertificate=True; Trusted_Connection=False; MultipleActiveResultSets=true;";
