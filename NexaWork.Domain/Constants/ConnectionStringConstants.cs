...
public static class ConnectionStringConstants
{
    ...
    public const string ConnectionString = "Server= 100.81.167.42, 1433; Database=NexaWorkDatabase; User Id=sa; password=Dai@2018; TrustServerCertificate=True; Trusted_Connection=False; MultipleActiveResultSets=true;";
    public const string MessageConnectionString = "Server= 100.81.167.42, 1433; Database=NexaMessageDB; User Id=sa; password=Dai@2018; TrustServerCertificate=True; Trusted_Connection=False; MultipleActiveResultSets=true;";
