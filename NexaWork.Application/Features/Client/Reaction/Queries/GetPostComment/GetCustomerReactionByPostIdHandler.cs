...
public class GetCustomerReactionByPostIdHandler : IRequestHandler<GetCustomerReactionByPostIdQuery, Boolean>
{
    ...
    public GetCustomerReactionByPostIdHandler(IReactionRepository reactionRepository, ICustomerRepository customerRepository, IPostRepository postRepository)
    {
