...
// import { useUserProfileData } from '../hook';
...
//   // 1. GỌI HOOK LẤY DỮ LIỆU THẬT Ở ĐÂY
//   const { profileData, isLoading, error } = useUserProfileData();
...
//   // 2. HIỂN THỊ LOADING NẾU ĐANG GỌI API
//   if (isLoading) {
//     return (
//       <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6 text-center text-gray-500">
...
//                 {/* COMMENT: Tên tĩnh của template */}
//                 {/* Musharof Chowdhury */}
                
//                 {/* CODE MỚI: Tên động từ Backend */}
//                 {profileData?.username || "Chưa cập nhật tên"}
//               </h4>
//               <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
//                 <p className="text-sm text-gray-500 dark:text-gray-400">
//                   {/* COMMENT: Template cũ để chức vụ */}
//                   {/* Team Manager */}

//                   {/* CODE MỚI: Bạn muốn hiển thị Email ở đây */}
...
//             {/* GIỮ NGUYÊN CÁC NÚT MẠNG XÃ HỘI... */}
...
//               {/* GIỮ NGUYÊN FORM SOCIAL LINKS MẶC ĐỊNH... */}
//               <div>
...
//                   {/* Ô NHẬP TÊN: Lấy username từ API bỏ vào */}
//                   <div className="col-span-2 lg:col-span-1">
//                     <Label>Username</Label>
//                     {/* COMMENT: <Input type="text" value="Musharof" /> */}
//                     <Input type="text" defaultValue={profileData?.username || ""} />
//                   </div>

//                   {/* COMMENT LẠI LAST NAME DO API GỘP CHUNG VÀO TRƯỜNG USERNAME RỒI */}
//                   <div className="col-span-2 lg:col-span-1">
//                     <Label>Last Name (Đã gộp vào Username)</Label>
//                     {/* <Input type="text" value="Chowdhury" /> */}
//                     <Input type="text" disabled defaultValue="" placeholder="Không dùng nữa" />
//                   </div>

//                   {/* Ô NHẬP EMAIL: Lấy email từ API */}
//                   <div className="col-span-2 lg:col-span-1">
//                     <Label>Email Address</Label>
//                     {/* COMMENT: <Input type="text" value="randomuser@pimjo.com" /> */}
//                     <Input type="text" defaultValue={profileData?.email || ""} disabled />
//                   </div>

//                   <div className="col-span-2 lg:col-span-1">
//                     <Label>Phone</Label>
//                     {/* COMMENT: <Input type="text" value="+09 363 398 46" /> */}
//                     <Input type="text" defaultValue="+09 363 398 46" />
//                   </div>

//                   <div className="col-span-2">
//                     <Label>Bio</Label>
//                     {/* COMMENT: <Input type="text" value="Team Manager" /> */}
...
//                 Close
//               </Button>
//               {/* Thêm type="button" để tránh reload trang khi chưa gọi API Save */}
