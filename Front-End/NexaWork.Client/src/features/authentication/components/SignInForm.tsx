...
export default function SignInForm() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-10 dark:bg-slate-950">
      <div className="w-full max-w-md space-y-8 rounded-3xl border border-slate-200 bg-white/95 p-8 shadow-lg shadow-slate-900/5 backdrop-blur dark:border-slate-800 dark:bg-slate-900/95">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="inline-flex w-full items-center justify-center rounded-lg bg-brand-500 px-5 py-3.5 text-sm font-medium text-white shadow-theme-xs transition hover:bg-brand-600 disabled:bg-brand-300"
            disabled={isLoading}
          >
        ...
        <div className="text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            ...
            <Link
              to="/sign-up"
              className="text-brand-500 transition hover:text-brand-600 dark:text-brand-400"
            >
              Sign up
            </Link>
          </p>
